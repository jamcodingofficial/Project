...
pygame.display.set_caption("Ultimate Flappy Bird - Asset Path Updated")
...
def get_path(filename):
    """파일명을 받아 09.img 폴더 내의 전체 경로를 반환합니다."""
