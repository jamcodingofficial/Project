# [사용 방법]
# 1. 실행 전 터미널에서 'pip install pygame numpy'를 입력해 패키지를 설치하세요.
# 2. 'python ball_simulation.py' 명령어로 코드를 실행합니다.
# 3. 화면이 뜨면 키보드로 원하는 공의 최대 개수(최대 15,000)를 입력하고 엔터를 누르세요.
# 4. 시뮬레이션이 시작되며, 목표 개수에 도달 후 5초 뒤 자동으로 첫 화면으로 리셋됩니다.
